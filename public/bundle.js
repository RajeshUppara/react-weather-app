	...
	var Weather = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(WeatherForm, { onSearch: this.handleSearch, location: location }),
	            renderMessage()
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=bcea89202c5a7a51a240e9106f31e214&units=imperial';
	module.exports = {
